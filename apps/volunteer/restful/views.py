...
from apps.base_serializers import PublicCashProjectSerializer, PublicNonCashProjectSerializer
from apps.charity.models import CashProject, NonCashProject
