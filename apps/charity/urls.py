...
from apps.charity.restful.views import charity_join_view, charity_profile_view, charity_cash_project_create_view, \
    ...
    charity_outgoing_requests_view, charity_feedback_view, charity_feedbacks_view, volunteers_view
...
urlpatterns = [
    ...
    path('my-feedbacks/', charity_feedbacks_view),
    path('volunteers/', volunteers_view)
]
